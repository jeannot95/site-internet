...
use Jeu\PagesBundle\Entity\Pages;
use Jeu\PagesBundle\Form\PagesType;
/**
 * Pages controller.
 *
 */
class PagesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JeuPagesBundle:Pages')->findAll();
        return $this->render('JeuPagesBundle:Administration:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('JeuPagesBundle:Administration:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('JeuPagesBundle:Pages')->find($id);
        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Pages entity.');
        }
        $deleteForm = $this->createDeleteForm($id);
        return $this->render('JeuPagesBundle:Administration:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        $deleteForm = $this->createDeleteForm($id);
        return $this->render('JeuPagesBundle:Administration:edit.html.twig', array(
            'entity'      => $entity,
