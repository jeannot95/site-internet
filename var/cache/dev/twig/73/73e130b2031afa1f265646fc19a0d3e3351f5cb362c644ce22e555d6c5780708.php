...
class __TwigTemplate_3eb2117cf2922666357bc7322f99a70870b5892cafaf60c8364d3ce06ef38839 extends Twig_Template
{
    private $source;
...
{% block body %}
    ...
    <table>
        ...
        {% for page in pages %}
            <tr>
                <td><a href=\"{{ path('adminPages_show', { 'id': page.id }) }}\">{{ page.id }}</a></td>
                <td>{{ page.titre }}</td>
                <td>{{ page.contenu }}</td>
                <td>
                    <ul>
                        <li>
                            <a href=\"{{ path('adminPages_show', { 'id': page.id }) }}\">show</a>
                        </li>
                        <li>
    ...
    <ul>
        <li>
            <a href=\"{{ path('adminPages_new') }}\">Create a new page</a>
        </li>
    </ul>
{% endblock %}
", ":pages:index.html.twig", "C:\\wamp\\www\\jeux\\app/Resources\\views/pages/index.html.twig");
    }
}
