 ...
 */
class PublicJeu extends \Jeu\ArticleBundle\Entity\PublicJeu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\PublicJeu' . "\0" . 'id', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\PublicJeu' . "\0" . 'name', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\PublicJeu' . "\0" . 'articles'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PublicJeu $proxy) {
