...
class __TwigTemplate_70878b4fff70b49661fc0963ae48921c74931cdfca4823bb8203b66f6462dc5d extends Twig_Template
{
    private $source;
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "contenu", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("adminPages_edit", array("id" => twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "id", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
";
    ...
    {
        return array (  84 => 33,  79 => 31,  73 => 28,  67 => 25,  57 => 18,  50 => 14,  43 => 10,  35 => 4,  32 => 3,  15 => 1,);
    }

    public function getSourceContext()
    {
        return new Twig_Source("", "pages/show.html.twig", "C:\\wamp\\www\\jeux\\app\\Resources\\views\\pages\\show.html.twig");
    }
}
