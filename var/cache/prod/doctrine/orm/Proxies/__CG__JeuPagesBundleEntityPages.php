...
namespace Proxies\__CG__\Jeu\PagesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Pages extends \Jeu\PagesBundle\Entity\Pages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\PagesBundle\\Entity\\Pages' . "\0" . 'id', '' . "\0" . 'Jeu\\PagesBundle\\Entity\\Pages' . "\0" . 'titre', '' . "\0" . 'Jeu\\PagesBundle\\Entity\\Pages' . "\0" . 'contenu'];
        }
