 ...
 */
class Commande extends \Jeu\UserBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'id', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'user', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'valider', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'date', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'reference', '' . "\0" . 'Jeu\\UserBundle\\Entity\\Commande' . "\0" . 'commande'];
        }
