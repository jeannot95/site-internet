 ...
 */
class Avis extends \Jeu\ArticleBundle\Entity\Avis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'id', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'note', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'titre', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'date', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'content', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'user', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Avis' . "\0" . 'article'];
        }
