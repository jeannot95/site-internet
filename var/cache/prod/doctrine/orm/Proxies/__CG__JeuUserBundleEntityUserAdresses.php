...
namespace Proxies\__CG__\Jeu\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UserAdresses extends \Jeu\UserBundle\Entity\UserAdresses implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'id', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'user', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'nom', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'prenom', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'telephone', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'adresse', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'cp', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'pays', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'ville', '' . "\0" . 'Jeu\\UserBundle\\Entity\\UserAdresses' . "\0" . 'complement'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserAdresses $proxy) {
