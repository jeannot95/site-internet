 ...
 */
class Extension extends \Jeu\ArticleBundle\Entity\Extension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Extension' . "\0" . 'id', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Extension' . "\0" . 'titre', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Extension' . "\0" . 'description', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Extension' . "\0" . 'prix', '' . "\0" . 'Jeu\\ArticleBundle\\Entity\\Extension' . "\0" . 'dateDeSortie'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Extension $proxy) {
