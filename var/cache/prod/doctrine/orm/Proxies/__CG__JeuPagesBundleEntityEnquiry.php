 ...
 */
class Enquiry extends \Jeu\PagesBundle\Entity\Enquiry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Jeu\\PagesBundle\\Entity\\Enquiry' . "\0" . 'id', 'name', 'email', 'subject', 'body'];
        }
