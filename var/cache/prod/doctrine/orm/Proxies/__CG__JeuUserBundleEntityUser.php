 ...
 */
class User extends \Jeu\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Jeu\\UserBundle\\Entity\\User' . "\0" . 'commandes', '' . "\0" . 'Jeu\\UserBundle\\Entity\\User' . "\0" . 'adresses', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
